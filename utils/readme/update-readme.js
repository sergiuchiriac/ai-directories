...
const url = 'https://aidirectori.es/?ref=github-readme'

const description = `<div align="center">The list that power <a href="${url}" target="_blank" rel="noopener">AI Directories</a> website</div>\n\n`
